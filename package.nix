{ stdenv, lib, cmake, boost, tbb, libGL, opensubdiv, darwin }:
stdenv.mkDerivation {
  ...
  buildInputs = [ boost tbb libGL opensubdiv ] ++ lib.optionals stdenv.isDarwin (with darwin.apple_sdk.frameworks; [Cocoa Metal MetalKit]);
